...
var e,
  ...
  m = t(require('@acyswap/v1-core/build/IUniswapV2Pair.json'))
;((n = exports.ChainId || (exports.ChainId = {}))[(n.MAINNET = 1)] = 'MAINNET'),
  (n[(n.ROPSTEN = 3)] = 'ROPSTEN'),
  (n[(n.RINKEBY = 4)] = 'RINKEBY'),
  (n[(n['GÖRLI'] = 5)] = 'GÖRLI'),
  (n[(n.KOVAN = 42)] = 'KOVAN'),
  (n[(n.KOVAN = 56)] = 'BSC_MAIN_NET'),
  (n[(n.KOVAN = 97)] = 'BSC_TEST_NET'),
  (n[(n.KOVAN = 137)] = 'POLYGON'),
...
var v,
  y = '0xfbf3b88d6f337be529b00f1dc9bff44bb43fa3c6b5b7d58a2149e59ac5e0c4a8',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
var tt,
  ...
  nt =
    ...
    (J[exports.ChainId.BSC_MAIN_NET] = new z(
    ...
    (J[exports.ChainId.BSC_TEST_NET] = new z(
    ...
    (J[exports.ChainId.POLYGON] = new z(
          ...
          (ft = P(
            ...
            (((u = {})[s[0].address] = P(
              ...
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0xb43DD1c50377b6dbaEBa3DcBB2232a3964b22440',
    ...
    (t.bestTradeExactIn = function (e, n, r, o, i, a, s) {
      ...
      for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            G(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), p, wt)
    ...
    (t.bestTradeExactOut = function (e, n, r, o, i, a, s) {
      ...
      for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            G(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), p, wt)
          else if (l > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = '0x3d077c05c3AbCE52257E453607209f81D9db01fC'),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
