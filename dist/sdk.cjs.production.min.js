...
var v,
  y = ConstantLoader().farmSetting.INIT_CODE_HASH,
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
          ...
          (ft = P(
            ...
            (((u = {})[s[0].address] = P(
              ...
              (((i = {})[s[1].address] = a.getCreate2Address(
                ConstantLoader().farmSetting.FACTORY_ADDRESS,
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = ConstantLoader().farmSetting.FACTORY_ADDRESS),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
